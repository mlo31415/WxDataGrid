...
class QueryDialog ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.wxLable = wx.StaticText( lable.GetStaticBox(), wx.ID_ANY, u"Enter the new column's thisrow", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.wxLable.Wrap( -1 )
		...
		self.m_textctl.SetMinSize( wx.Size( 300,-1 ) )
...
def MessageBoxInput(prompt: str="", title="", initialValue: str="", ignoredebugger: bool=True, Parent=None) -> str:
    dlg=QueryDialog(Parent)
    dlg.Title=title
